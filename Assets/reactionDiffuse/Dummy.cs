...
public class Dummy : MonoBehaviour {
	...
	private Material 		mReactionDiffusionMaterial = null;
	...
	void Start () {
		...
		mReactionDiffusionMaterial = new Material(Shader.Find("Custom/ReactionDiffusion"));
	...
	void OnGUI(){
		...
		GUI.Label(new Rect (10, 120, 200, 100), "Click anywhere to add reactant");
